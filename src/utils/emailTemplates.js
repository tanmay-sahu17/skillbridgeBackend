...
/**
 * Generates the HTML template for Reset Password email
            ...
            <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="padding:45px 45px 20px;color:#ffffff;">
                        ...
                        <p style="color:#bdbdbd;font-size:15px;line-height:26px;">
                            We received a request to reset the password for your <strong style="color:#ffffff;">SkillBridge</strong> account. Click the button below to choose a new password.
                        </p>
                        ...
                        <p style="color:#bdbdbd;font-size:14px;line-height:24px;">
                            This link is valid for <strong style="color:#ffffff;">15 minutes</strong>.
                        </p>
